...
<div class="container mt-5">
    ...
    <form action="check_sign_up.php" method="post">
        ...
        <input type="password" name="confirm_password" placeholder="Повторите ваш пароль" class="form-control"/><br/>

        <input name="click" type="submit" value="Зарегистрироваться" class="btn btn-success">
    </form>
</div>
</body>
</html>